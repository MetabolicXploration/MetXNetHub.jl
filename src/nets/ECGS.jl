...
function _register_ECGS()
    register_network!("ECGS", _ECGS_builder;
        ...
        desc = "An slightly modified iJO1366 (see source) model in a minimum glucose rich medium (max uptake: 10.0 mmol/gDW h), the raw model was extracted from 41598_2017_BFsrep39647_MOESM451_ESM.xls supplementary data"
    )
end